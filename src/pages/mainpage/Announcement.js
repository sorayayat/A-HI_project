                ...
                <div className={styles.anmContents}>
                    <div className={styles.anmList}>
                        <div className={styles.anmTrack}>
                            {announcements.slice(startIndex, startIndex + numToShow).map((announcement, index) => (
                                <div key={index} data-index={index} className={styles.slick}>
                                    <div className={styles.jobContainer}>
                                        <div data-cy={`jobCard-${index}`}>
